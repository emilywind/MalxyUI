local defaultFonts = {
  DAMAGE_TEXT_FONT = DAMAGE_TEXT_FONT,
  STANDARD_TEXT_FONT = STANDARD_TEXT_FONT,
  UNIT_NAME_FONT = UNIT_NAME_FONT,
  NAMEPLATE_FONT = NAMEPLATE_FONT,
  NAMEPLATE_SPELLCAST_FONT = NAMEPLATE_SPELLCAST_FONT
}
...
function UpdateFonts()
  if EUIDB.enableDamageFont then
    ...
    DAMAGE_TEXT_FONT = defaultFonts.DAMAGE_TEXT_FONT
  end
